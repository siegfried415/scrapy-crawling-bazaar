...
由于Crawler没有自己的爬取目标，所以在Crawler Spider中无需设置start_urls。具体例子可以参考 `example-crawling-bazaar<https://github.com/siegfried415/scrapy-crawling-bazaar/example-crawling-bazaar>`
