...
setup(
    name='scrapy-crawling-bazaar',
    version=read_file('VERSION'),
    description="scrapy build on crawling bazaar.",
    #long_description=read_rst('README.rst') + '\n\n' + read_rst('HISTORY.rst'),
    author="siegfried415",
    author_email='siegfried415@gmail.com',
    url='https://github.com/siegfried415/scrapy-crawling-bazaar',
    ...
    license="MIT",
    keywords='scrapy-crawling-bazaar',
    classifiers=[
